const CONFIG = {
    mainQuestion: "YEAAAY! Kamu sekarang resmi jadi pacar aku. Kontraknya berlaku seumur hidup",
    ...
    confirmText: "Makasih udah bilang Iya kemarin dan juga di website ini",
    badgeText: "Sekarang kamu resmi jadi pacar aku",
    nextButton: "Lanjut ",
    repeatButton: "Ulangi pertanyaan",
    flowerTitle: "Ini bunga spesial buat kamu ",
    ...
    collageSubtitle: "Sejak kamu hadir, hal sederhana pun terasa istimewa. Makasih sudah jadi bagian dari hidup aku. 💕",
    nextCollageButton: "Satu halaman lagi… ",
    finalTitle: "Hai kamu 💞",
    finalMessage: `Website ini mungkin sederahana, tapi aku bikin khusus buat kamu. Makasih sudah datang ke hidup aku dan makasih sudah mau jadi pacar aku. Semoga mulai hari ini kita bisa bikin banyak cerita, banyak tawa, dan banyak kenangan bareng. I'm really lucky to have you. 💕`,
